...
/**
 * Gson 은 JAVA 8 이후에 새로 나온 build-in class 를 지원하지 않는다. 따라서 이 클래스들을 처리해주기 위해 TypeAdapter 를 직접 작성하여 Gson 객체를 생성할 때 주입한다.
 * 그냥 사용할 경우 Illgal reflective access 경고가 발생한다.
 */
