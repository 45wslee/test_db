...
public class BrowserUtil {
    ...
    public static String getDisposition(String filename, String userAgent, String charSet) throws Exception {
        ...
        //System.out.println("=====>>>>> browser type = "+result.get(TYPEKEY));asasdf
        //System.out.println("=====>>>>> browser version = "+result.get(VERSIONKEY));asdfd fasdf;ㅣㅏㅓㅏㅣ;ㅓ
