        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="check_radio_group">
                        <div class="checks">
                            <input type="checkbox" id="check_01" checked />
                            <label for="check_01">Check 01</label>
                        </div>
                        <div class="checks">
                            <input type="checkbox" id="check_02" />
                            <label for="check_02">Check 02</label>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="check_radio_group">
                        <div class="radios">
                            <input type="radio" id="item_01" name="radio_01" checked />
                            <label for="item_01">YES</label>
                        </div>
                        <div class="radios">
                            <input type="radio" id="item_02" name="radio_01" />
            ...
            <tr>
                <th>Textarea</th>
                <td>
                    <textarea name="textarea" id="textarea" cols="30" rows="10" placeholder="내용을 입력하세요."></textarea>
                </td>
            </tr>
            <tr>
