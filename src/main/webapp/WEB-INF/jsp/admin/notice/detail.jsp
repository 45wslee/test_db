...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/common/ckeditor5/ckeditor.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/common/ckeditor5/config.js"></script>
        ...
        <div class="table_wrap">
            ...
            <div class="table_area">
                <form id="frm" name="frm" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="ntcSn" value="<c:out value="${notice.ntcSn}"/>"/>
                    <table class="contentsTable1">
                        ...
                        <tr>
                            ...
                            <td colspan="3"><input type="text" class="W1200" name="ntcTtl" value="<c:out value="${notice.ntcTtl}"/>"></td>
                        </tr>
                        <tr>
                            <th>첨부파일</th>
                            <td colspan="3">
                                ...
                                <div class="conTable_file" style="flex-direction: column;display: flex;">
                                    <c:forEach var="file" items="${notice.fileList}">
                                        <p>
                                            <a href="${pageContext.request.contextPath}/file/${file.fileSn}/${file.srvrFileNm}">${file.fileSn} ${file.orgnlFileNm}</a>
                                            <button type="button" class="btn03 btn_red_line" onclick="deleteFile('<c:out value="${file.fileSn}"/>'); removeThis(this)">삭제</button>
                                        </p>
                                        <%--        <img src="${pageContext.request.contextPath}/image/${file.fileSn}/${file.srvrFileNm}"/>--%>
                                    </c:forEach>
                                </div>
                                <div class="conTable_file" id="file_contents" style="flex-direction: column;display: flex;">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <th class="red_dot">내용</th>
                            <td colspan="3"><textarea name="ntcCn" id="editor"><c:out value="${notice.ntcCn}"/></textarea></td>
                        </tr>
                    </table>
                </form>
            </div>
            ...
            <div class="table_bottom">
                ...
                <div class="table_bot_right">
                    <button type="button" class="btn04 btn_blue2" onclick="updateNotice()">수정</button>
                </div>
            </div>
        </div>
    </div>
